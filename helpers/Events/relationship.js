...
export default async function on({ cht, Exp, store, ev, is }) {
        ...
        const menu = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    mediaUrl: "http://ẉa.me/6288211118394/"+Math.floor(Math.random() * 100000000000000000),
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                },
        ...
        const mess = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    sourceUrl: "https://github.com/Usbeje",
                    mediaUrl: `http://ẉa.me/6288211118394/${user.charging ? "2733":"2734"}`,
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                }
    ...
    ev.on({ 
        ...
        if(premium) return cht.reply("Tidak dapat claim trial, kamu sudah premium!")
            ...
            user.premium.time = Date.now() + 999999999999999999999999999999999999999999999999999999999999
        Data.users[usr] = user
